package cn.sunyblog.javaemaildemo.processor.config;
...
import cn.sunyblog.javaemaildemo.processor.handler.EmailHandlerExecutor;
...
// @Component
public class AnnotationDrivenEmailProcessorManager {
    
    private final EmailHandlerRegistry handlerRegistry;
    private final EmailHandlerExecutor handlerExecutor;
    private final EmailContextBuilder contextBuilder;
    private final AnnotationDrivenEmailProcessorProperties properties;
    ...
    public AnnotationDrivenEmailProcessorManager(
     ...
     * @return 配置信息
     */
    public AnnotationDrivenEmailProcessorProperties getProperties() {
        return properties;
    }
