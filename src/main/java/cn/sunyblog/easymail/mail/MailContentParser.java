...
public class MailContentParser {
        ...
        if (disposition != null && disposition.equalsIgnoreCase(BodyPart.ATTACHMENT)) {
            ...
            if (!outputDir.exists()) {
                if (outputDir.mkdirs()) {
                    ...
                    throw new EmailProcessException("创建附件保存目录失败: " + saveDir);
                }
            }
            ...
            try (InputStream is = bodyPart.getInputStream();
                ...
                throw EmailProcessException.processingError("保存附件失败: " + fileName, e);
            }
        }
    }
    ...
    public String decodeText(String text) {
        ...
        try {
            ...
            throw EmailProcessException.parsingError("解码文本失败: " + text, e);
        }
    }
