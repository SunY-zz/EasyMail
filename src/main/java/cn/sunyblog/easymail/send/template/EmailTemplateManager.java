...
public class EmailTemplateManager {
     ...
     * 模板缓存
     */
    private static final Map<String, EmailTemplate> templateCache = new ConcurrentHashMap<>();
    ...
    public void initDefaultTemplates() {
        // 注册预定义模板
        registerTemplate(EmailTemplate.createVerificationCodeTemplate());
        registerTemplate(EmailTemplate.createWelcomeTemplate());
        registerTemplate(EmailTemplate.createPasswordResetTemplate());
        registerTemplate(EmailTemplate.createNotificationTemplate());
     ...
     * @return 是否注册成功
     */
    public static EmailTemplate registerTemplate(EmailTemplate template) {
    ...
    public boolean removeTemplate(String templateId) {
        ...
        EmailTemplate removed = templateCache.remove(templateId);
        if (removed != null) {
     ...
     * @return 模板映射的副本
     */
    public Map<String, EmailTemplate> getAllTemplates() {
