...
public interface EmailSenderService {
    ...
    SendResult send(List<String> toList, String subject, String content);

    SendResult send(List<String> toList, String subject, String content, boolean isHtml);

    SendResult send(List<String> toList, String subject, String content, List<File> attachments);
     ...
     * @return 发送结果
     */
    SendResult sendWithTemplate(String to, EmailTemplate template, Map<String, Object> variables) throws Exception;
     ...
     * @return 批量发送结果
     */
    SendResult sendBatchWithTemplate(Map<String, Map<String, Object>> recipients, EmailTemplate template) throws Exception;
