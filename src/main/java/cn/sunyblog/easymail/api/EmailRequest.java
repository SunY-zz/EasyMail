...
public class EmailRequest {
     ...
     * 验证邮件请求并抛出异常
     *
     * @throws cn.sunyblog.easymail.exception.EmailValidationException 验证失败时抛出
     */
    public void validateAndThrow() throws cn.sunyblog.easymail.exception.EmailValidationException {
        ValidationResult result = validate();
        if (!result.isValid()) {
            throw new cn.sunyblog.easymail.exception.EmailValidationException(
     ...
     */
    public static EmailRequest simpleText(String to, String subject, String text) {
     ...
     * @return EmailRequest实例
     */
    public static EmailRequest htmlEmail(String to, String subject, String html) {
        return EmailRequest.builder()
                .to(to)
                .subject(subject)
                .html(html)
     ...
     * @return EmailRequest实例
     */
    public static EmailRequest templateEmail(String to, String templateId, Map<String, Object> variables) {
        return EmailRequest.builder()
                .to(to)
