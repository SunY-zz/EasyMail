...
public class EmailConnectionException extends EmailException {
     ...
     * @param port    端口号
     */
    public EmailConnectionException(String message, String server, Integer port) {
     ...
     * @param cause   原因异常
     */
    public EmailConnectionException(String message, String server, Integer port, Throwable cause) {
     ...
     * @param port      端口号
     */
    public EmailConnectionException(String errorCode, String message, String server, Integer port) {
     ...
     * @param cause     原因异常
     */
    public EmailConnectionException(String errorCode, String message, String server, Integer port, Throwable cause) {
