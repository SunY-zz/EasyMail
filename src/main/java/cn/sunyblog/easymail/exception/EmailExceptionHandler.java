...
public class EmailExceptionHandler {
     ...
     */
    public static EmailException wrapException(Throwable throwable, String context) {
        if (throwable == null) {
            return new EmailException("未知异常");
        }

        // 如果已经是EmailException，直接返回
        if (throwable instanceof EmailException) {
            return (EmailException) throwable;
        }
        ...
        // 默认包装
        return new EmailException("EMAIL_UNKNOWN_ERROR",
     ...
     */
    public static EmailException wrapMessagingException(MessagingException ex, String context) {
        String message = ex.getMessage();

        // 连接相关异常
        if (isConnectionException(ex)) {
            return new EmailConnectionException(
     ...
     * @return EmailException
     */
    public static EmailException wrapIOException(IOException ex, String context) {
        String message = ex.getMessage();
     ...
     * @return EmailException
     */
    private static EmailException wrapRuntimeException(RuntimeException ex, String context) {
        String message = ex.getMessage();
     ...
     */
    public static void logException(EmailException exception, String operation) {
        if (exception == null) {
            return;
        }
